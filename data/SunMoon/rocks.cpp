...
static const ROCK rocks[N_ROCKS] = {
   ...
   {  618,             /* Pan SAT357eq */
      2451545.000000000,                    /* element epoch Julian date     */
       1.335848403056548E+05,               /* a = semi-major axis (km)      */
       1.184137532026823E-06,               /* h = e sin(periapsis longitude)*/
      -3.795001338256199E-06,               /* k = e cos(periapsis longitude)*/
       1.465934643173052E+02 * PI / 180.,   /* l = mean longitude (deg)      */
       3.485750239434890E-06,               /* p = tan(i/2) sin(node)        */
       1.868116711429591E-06,               /* q = tan(i/2) cos(node)        */
       3.711667873563986E-05 * PI / 180.,   /* apsis rate (deg/sec)          */
       7.245737663080527E-03 * PI / 180.,   /* mean motion (deg/sec)         */
      -3.692848983924850E-05 * PI / 180.,   /* node rate (deg/sec)           */
       4.058266021370071E+01 * PI / 180.,   /* Laplacian plane pole ra (deg) */
       8.353762557532015E+01 * PI / 180. }, /* Laplacian plane pole dec (deg)*/

   {  635,             /* Daphnis SAT357eq */
      2451545.0,                            /* element epoch Julian date     */
       1.365034061742419E+05,               /* a = semi-major axis (km)      */
       7.953373144505403E-06,               /* h = e sin(periapsis longitude)*/
       1.544106618779353E-05,               /* k = e cos(periapsis longitude)*/
       1.535815515789244E+02 * PI / 180.,   /* l = mean longitude (deg)      */
       1.989291987836432E-05,               /* p = tan(i/2) sin(node)        */
      -1.400452041662295E-05,               /* q = tan(i/2) cos(node)        */
       3.436678564527815E-05 * PI / 180.,   /* apsis rate (deg/sec)          */
       7.013647605763186E-03 * PI / 180.,   /* mean motion (deg/sec)         */
      -3.420001234488550E-05 * PI / 180.,   /* node rate (deg/sec)           */
       4.058266021370071E+01 * PI / 180.,   /* Laplacian plane pole ra (deg) */
       8.353762557532015E+01 * PI / 180. }, /* Laplacian plane pole dec (deg)*/
   ...
   {  727,             /* Cupid URA091*/
    ...
    { 801,  /* Triton, aka Neptune I: NEP050 */
       2447763.5,                           /* element epoch Julian date     */
