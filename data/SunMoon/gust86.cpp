...
/* --- RL => mean longitude (radians) ---- */
   ...
   extra_terms[0] = -123.31e-6;
   extra_terms[1] = -an[0] + 2.*an[1];
   extra_terms[2] = 39.52e-6;
   extra_terms[3] = -2. * an[0] + 3.*an[1];
   extra_terms[4] = 194.10e-6;
   extra_terms[5] = an[0];
...
/* --- RL => mean longitude (radians) --- */
   ...
   extra_terms[0] = -84.60e-06;
   extra_terms[1] =  2. * an[2] - an[1];
   extra_terms[2] =  +91.81e-06;
   extra_terms[3] =  3. * an[2] - 2. * an[1];
   extra_terms[4] =  +20.03e-06;
   extra_terms[5] =  2. * an[3] - an[1];
   extra_terms[6] =  +89.77e-06;
   extra_terms[7] =  an[1];
...
/* --- RL => mean longitude (radians) --- */
   ...
   extra_terms[0]  =  29.34e-6;
   extra_terms[1]  = an[1];
   extra_terms[2]  = 26.20e-6;
   extra_terms[3]  = an[2];
   extra_terms[4]  = 51.19e-6;
   extra_terms[5]  = -an[1]+2.*an[2];
   extra_terms[6]  = -103.86e-6;
   extra_terms[7]  = -2.*an[1]+3.*an[2];
   extra_terms[8]  = -27.16e-6;
   extra_terms[9]  = -3.*an[1]+4.*an[2];
   extra_terms[10] = -16.22e-6;
   extra_terms[11] =  an[3];
   extra_terms[12] = 549.23e-6;
   extra_terms[13] = -an[2]+2.*an[3];
   extra_terms[14] = 34.70e-6;
   extra_terms[15] = -2.*an[2]+3.*an[3];
   extra_terms[16] = 12.81e-6;
   extra_terms[17] = -3.*an[2]+4.*an[3];
   extra_terms[18] = 21.81e-6;
   extra_terms[19] = -an[2]+2.*an[4];
   extra_terms[20] = 46.25e-6;
   extra_terms[21] = an[2];
...
/* --- RL => mean longitude (radians) --- */
   ...
   extra_terms[0] = 33.86e-6;
   extra_terms[1] = an[1];
   extra_terms[2] = 17.46e-6;
   extra_terms[3] = an[3];
   extra_terms[4] = 16.58e-6;
   extra_terms[5] = -an[1]+2.*an[3];
   extra_terms[6] = 28.89e-6;
   extra_terms[7] = an[2];
   extra_terms[8] = -35.86e-6;
   extra_terms[9] = -an[2]+2.*an[3];
   extra_terms[10] = -17.86e-6;
   extra_terms[11] = an[3];
   extra_terms[12] = -32.10e-6;
   extra_terms[13] = an[4];
   extra_terms[14] = -177.83e-6;
   extra_terms[15] = -an[3]+2.*an[4];
   extra_terms[16] = 793.43e-6;
   extra_terms[17] = -2.*an[3]+3.*an[4];
   extra_terms[18] = 99.48e-6;
   extra_terms[19] = -3.*an[3]+4.*an[4];
   extra_terms[20] = 44.83e-6;
   extra_terms[21] = -4.*an[3]+5.*an[4];
   extra_terms[22] = 25.13e-6;
   extra_terms[23] = -5.*an[3]+6.*an[4];
   extra_terms[24] = 15.43e-6;
   extra_terms[25] = -6.*an[3]+7.*an[4];
...
/* --- RN => mean motion (radians/day) --- */
   ...
   elems[1] +=      282.78e-06*sin(2.*an[3]-2.*an[4])
    ...
    extra_terms[0] = 39.00e-6;
    extra_terms[1] = an[1];
    extra_terms[2] = 17.66e-6;
    extra_terms[3] = -an[1]+2.*an[4];
    extra_terms[4] = 32.42e-6;
    extra_terms[5] = an[2];
    extra_terms[6] = 79.75e-6;
    extra_terms[7] = an[3];
    extra_terms[8] = 75.66e-6;
    extra_terms[9] = an[4];
    extra_terms[10] = 134.04e-6;
    extra_terms[11] = -an[3]+2.*an[4];
    extra_terms[12] = -987.26e-6;
    extra_terms[13] = -2.*an[3]+3.*an[4];
    extra_terms[14] = -126.09e-6;
    extra_terms[15] = -3.*an[3]+4.*an[4];
    extra_terms[16] = -57.42e-6;
    extra_terms[17] = -4.*an[3]+5.*an[4];
    extra_terms[18] = -32.41e-6;
    extra_terms[19] = -5.*an[3]+6.*an[4];
    extra_terms[20] = -19.99e-6;
    extra_terms[21] = -6.*an[3]+7.*an[4];
    extra_terms[22] = -12.94e-6;
    extra_terms[23] = -7.*an[3]+8.*an[4];
